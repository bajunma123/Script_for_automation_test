...
test_result =  []
get_information(page='--page=0x0a', index='--index=ps,0')
print('Remove PSU A')
time.sleep(30)
get_information(page='--page=0x0a', index='--index=ps,0')
print('Insert PSU A')
time.sleep(30)
get_information(page='--page=0x0a', index='--index=ps,1')
print('Remove PSU B')
time.sleep(30)
get_information(page='--page=0x0a', index='--index=ps,1')
print('Insert PSU B')
...
result = dict(enumerate(test_result))
# print(result)
write_into_file('SES-13-3--SES001003.txt')
...
result = dict(enumerate(test_result))
# print(result)
write_cli_into_file('SES-13-3--SES001006.txt')
